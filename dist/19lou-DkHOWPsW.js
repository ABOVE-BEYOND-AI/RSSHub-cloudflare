import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import"./helpers-LVq640iW.js";import{cache_default as e}from"./cache-C3AIQtoX.js";import{parseDate as t}from"./parse-date-DHsdom8D.js";import"./ofetch-DRl42yaJ.js";import{got_default as n}from"./got-BaOFZRd4.js";import{timezone as r}from"./timezone-BrxBCotj.js";import{invalid_parameter_default as i}from"./invalid-parameter-CfUmvEUg.js";import{isValidHost as a}from"./valid-host-JqD2S4D4.js";import{load as o}from"cheerio";import s from"iconv-lite";const c=function(e,t,n,r,i,a){let o=null;return n!==-1&&(o=new Date,o.setTime(o.getTime()+n)),[encodeURI(e),`=`,encodeURI(t),o?`; expires=`+o.toGMTString():``,r?`; path=`+r:`/`,i?`; domain=`+i:``,a?`; secure`:``].join(``)},l={path:`/:city?`,categories:[`bbs`],example:`/19lou/jiaxing`,parameters:{city:`分类，见下表，默认为 www，即杭州`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`头条`,maintainers:[`nczitzk`],handler:u,description:`| 杭州 | 台州    | 嘉兴    | 宁波   | 湖州   |
| ---- | ------- | ------- | ------ | ------ |
