import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import"./helpers-LVq640iW.js";import{parseRelativeDate as e}from"./parse-date-DHsdom8D.js";import"./ofetch-DRl42yaJ.js";import{got_default as t}from"./got-BaOFZRd4.js";import{load as n}from"cheerio";const r={path:`/posts/:cid/:sort?`,categories:[`programming`],example:`/learnblockchain/posts/DApp/newest`,parameters:{cid:`分类id,更多分类可以论坛的URL找到`,sort:`排序方式，默认精选`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`文章`,maintainers:[`running-grass`],handler:i,description:`| id       | 分类         |
| -------- | ------------ |
| all      | 全部         |
| DApp     | 去中心化应用 |
| chains   | 公链         |
