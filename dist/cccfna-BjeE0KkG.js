import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{cache_default as e}from"./cache-C3AIQtoX.js";import{parseDate as t}from"./parse-date-DHsdom8D.js";import{ofetch_default as n}from"./ofetch-DRl42yaJ.js";import{timezone as r}from"./timezone-BrxBCotj.js";import{load as i}from"cheerio";const a={path:`/:category/:type?`,categories:[`government`],example:`/cccfna/meirigengxin`,parameters:{category:`文章种类，即一级分类，详情见下表`,type:`文章类型，即二级分类，详情见下表`},radar:[{source:[`www.cccfna.org.cn/:category/:type?`]}],description:`
::: tip
