import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{parseDate as e}from"./parse-date-DHsdom8D.js";import{ofetch_default as t}from"./ofetch-DRl42yaJ.js";const n={path:`/events`,name:`Link3 Events`,url:`link3.to`,maintainers:[`cxheng315`],example:`/link3/events`,categories:[`other`],features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`link3.to/events`],target:`/events`}],handler:r};async function r(){let n=await t(`https://api.cyberconnect.dev/profile/`,{method:`POST`,headers:{"Content-Type":`application/json`},body:{variables:{order:`START_TIME_ASC`},query:`
