import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{ofetch_default as e}from"./ofetch-DRl42yaJ.js";import{load as t}from"cheerio";const n={path:`/job/calendar`,categories:[`university`],example:`/hrbeu/job/calendar`,parameters:{},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`job.hrbeu.edu.cn/*`]}],name:`就业服务平台`,maintainers:[`Derekmini`],handler:r,url:`job.hrbeu.edu.cn/*`,description:`| 通知公告 | 热点新闻 |
| :------: | :------: |
|   tzgg   |   rdxw   |
