import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{cache_default as e}from"./cache-C3AIQtoX.js";import"./parse-date-DHsdom8D.js";import{ofetch_default as t}from"./ofetch-DRl42yaJ.js";import{baseUrl as n,gqlEndpoint as r,parseItem as i}from"./utils-CRuSSa-p.js";import*as a from"cheerio";const o=r=>e.tryGet(`matters:tags:${r}`,async()=>{let e=await t(`${n}/tags/${r}`),i=a.load(e),o=JSON.parse(i(`script#__NEXT_DATA__`).text()),s=Object.entries(o.props.apolloState.data.ROOT_QUERY).find(([e])=>e.startsWith(`node`))?.pop();return s?.id.split(`:`)[1]}),s=async e=>{let{tid:a}=e.req.param(),s=e.req.query(`limit`)?Number.parseInt(e.req.query(`limit`),10):20,c=await o(a),l=await t(r,{method:`POST`,body:{query:`{
                node(input: {id: "${c}"}) {
                  ... on Tag {
                    content
                    description
