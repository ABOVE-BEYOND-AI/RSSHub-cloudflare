import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{parseDate as e}from"./parse-date-DHsdom8D.js";import{ofetch_default as t}from"./ofetch-DRl42yaJ.js";const n={path:`/profile/:handle`,name:`Link3 Profile`,url:`link3.to`,maintainers:[`cxheng315`],example:`/link3/profile/synfutures_defi`,parameters:{handle:`Profile handle`},categories:[`other`],features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`link3.to/:handle`],target:`/:handle`}],handler:r};async function r(n){let r=n.req.param(`handle`),i=await t(`https://api.cyberconnect.dev/profile/`,{method:`POST`,headers:{"Content-Type":`application/json`},body:{variables:{handle:r},query:`
