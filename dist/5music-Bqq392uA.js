import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import"./helpers-LVq640iW.js";import{parseDate as e}from"./parse-date-DHsdom8D.js";import"./ofetch-DRl42yaJ.js";import{got_default as t}from"./got-BaOFZRd4.js";import{load as n}from"cheerio";const r={path:`/new-releases/:category?`,categories:[`shopping`],example:`/5music/new-releases`,parameters:{category:`Category, see below, defaults to all`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`www.5music.com.tw/New_releases.asp`,`www.5music.com.tw/`],target:`/new-releases`}],name:`新貨上架`,maintainers:[`gideonsenku`],handler:i,description:`Categories:
| 華語 | 西洋 | 東洋 | 韓語 | 古典 |
| ---- | ---- | ---- | ---- | ---- |
