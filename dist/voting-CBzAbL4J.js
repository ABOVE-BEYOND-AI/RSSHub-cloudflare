import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import{ofetch_default as e}from"./ofetch-DRl42yaJ.js";const t=`https://www.openrice.com`,n={path:`/:lang/hongkong/voting/top/:categoryKey`,maintainers:[`after9`],handler:r,categories:[`shopping`],example:`/openrice/zh/hongkong/voting/top/chinese`,parameters:{lang:`语言，缺省为 zh`,categoryKey:`类别，缺省为 chinese`},name:`OpenRice 開飯熱店 - 年度餐廳投票`,description:`
  lang: 语言，见下方列表
| 简体 | 繁體 | EN |
| ----- | ------ | ----- |
| zh-cn | zh | en |
