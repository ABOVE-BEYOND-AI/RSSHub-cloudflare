import"./config-HRWLmo66.js";import"./logger-DHpG8Bim.js";import"./helpers-LVq640iW.js";import{parseDate as e}from"./parse-date-DHsdom8D.js";import"./ofetch-DRl42yaJ.js";import{got_default as t}from"./got-BaOFZRd4.js";import{timezone as n}from"./timezone-BrxBCotj.js";const r={path:`/ceic/:type?`,categories:[`forecast`],example:`/earthquake/ceic/1`,parameters:{type:`类型，见下表`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`www.cea.gov.cn/cea/xwzx/zqsd/index.html`,`www.cea.gov.cn/`],target:``}],name:`中国地震台`,maintainers:[`SettingDust`],handler:i,url:`www.cea.gov.cn/cea/xwzx/zqsd/index.html`,description:`| 参数 | 类型                        |
| ---- | --------------------------- |
| 1    | 最近 24 小时地震信息        |
| 2    | 最近 48 小时地震信息        |
| 5    | 最近一年 3.0 级以上地震信息 |
